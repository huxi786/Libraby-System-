...
<head>
    ...
    {{-- ✅ FIX: JQuery ko yahan Global laga diya taake har page par chale --}}
...
<body>
    ...
    <header class="admin-header">
        ...
        <nav class="admin-nav">
            <a href="{{ route('admin.welcome') }}" class="nav-item {{ request()->routeIs('admin.') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.requests') }}"
                ...
                @if (isset($requestCount) && $requestCount > 0)
                    <span class="badge-notification">{{ $requestCount }}</span>
                @endif
            </a>
            ...
            <a href="{{ route('admin.users') }}"
                ...
                @if (isset($userCount) && $userCount > 0)
                    <span class="badge-notification">{{ $userCount }}</span>
                @endif
            </a>
            ...
            <a href="{{ route('admin.messages') }}"
                ...
                @if (isset($msgCount) && $msgCount > 0)
                    <span class="badge-notification">{{ $msgCount }}</span>
                @endif
            </a>
        </nav>
